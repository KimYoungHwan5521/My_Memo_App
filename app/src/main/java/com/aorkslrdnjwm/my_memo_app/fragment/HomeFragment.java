package com.aorkslrdnjwm.my_memo_app.fragment;
...
import com.aorkslrdnjwm.my_memo_app.R;
import com.aorkslrdnjwm.my_memo_app.adapter.MemoViewPagerAdapter;
import com.aorkslrdnjwm.my_memo_app.database.MemoVO;
...
//        return super.onCreateView(inflater, container, savedInstanceState);
        ...
        FirebaseDatabase.getInstance().getReference().child("my_memo").addValueEventListener(new ValueEventListener() {
            @Override
